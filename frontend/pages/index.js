...
export default function Home() {
  ...
  // Function to make a createProposal transaction in DAO
  ...
  async function voteForProposal(projectId, vote) {
    setLoading(true);
    try {
      console.log("asdf");
      const tx = await writeContract({
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own CryptoDevsNFTs. <br />
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            ...
            {numOfProposalsInDAO.data !== undefined
          ...
          {address && daoOwner.data !== undefined /*&&
